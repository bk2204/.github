...
* Sign-off your work.
  By doing so, you are certifying the statement in the <<dco,Developer's Certificate of Origin>>, including the interpretation of the <<llm,Use of Large Language Models statement>>.
...
It is the position of this project that output from so-called "`AI`" whose training data contains certain software is considered a derivative thereof and thus any further dealing in the output is subject to the appropriate license.
Thus, please do not sign off your work if you're using an LLM to contribute unless you have included copyright and license information for all the code used in that LLM.
